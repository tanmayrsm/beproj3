...
public class User {
    public String name,email,password,userid,my_lang,fb_val,lang;

    public User(){}

    public User(String name, String email, String password, String userid, String my_lang, String fb_val, String lang) {
        this.name = name;
        this.email = email;
