    ...
    public void start ()
    {
        ...
        if (url != null && url.trim ().length() > 0)
        {
            ...
            catch (Throwable t)
            {
                ...
                {
                    JOptionPane.showMessageDialog(SimplePrintApplet.this, t.getMessage());
                }
                else
                {
                    JOptionPane.showMessageDialog(SimplePrintApplet.this, "Error loading PDF document: " + url);
                }
            }
        }
        ...
        if (redirectURL != null && redirectURL.trim().length() > 0)
        {
            ...
            catch (Throwable t)
            {
                ...
                {
                    JOptionPane.showMessageDialog(SimplePrintApplet.this, "Error redirecting browser to " + redirectURL);
                }
            }
        }
    }
